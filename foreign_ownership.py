...
df_guo.to_csv("csv/db_guo.csv", sep = ',', index=False)

df_guo = pd.read_csv("csv/db_guo.csv", sep = ',', index_col = False)
df_orbis = pd.read_csv("csv/db_orbisU2.csv", sep = ',', index_col = False)
...
df.to_csv("csv/db_foreign.csv", sep = ',')
df = pd.read_csv("csv/db_foreign.csv", sep = ',', index_col = False)

# =============================================================================
# REMOVE DUPLICATES AND FINANCIAL COMPANIES FROM PANEL DATA (MULTIPLE YEARS)
# =============================================================================
...
df['short_term_lev'] = df.loans/df.tot_assets
df['long_term_lev'] = df.ltdebt/df.tot_assets
...
debt_EA = df[df.year!='2018'].groupby('year').tot_debt.sum()
debt_DE = df[(df.country=="DE") & (df.year!='2018')].groupby('year').tot_debt.sum()
debt_ES = df[(df.country=="ES") & (df.year!='2018')].groupby('year').tot_debt.sum()
debt_FR = df[(df.country=="FR") & (df.year!='2018')].groupby('year').tot_debt.sum()
debt_IT = df[(df.country=="IT") & (df.year!='2018')].groupby('year').tot_debt.sum()

plt.plot(debt_EA, label="EA")
plt.plot(debt_DE, label="DE")
plt.plot(debt_ES, label="ES")
plt.plot(debt_FR, label="FR")
plt.plot(debt_IT, label="IT")
plt.legend()


count_EA = df[df.year!='2018'].groupby('year').id.count()
count_DE = df[(df.country=="DE") & (df.year!='2018')].groupby('year').id.count()
count_ES = df[(df.country=="ES") & (df.year!='2018')].groupby('year').id.count()
count_FR = df[(df.country=="FR") & (df.year!='2018')].groupby('year').id.count()
count_IT = df[(df.country=="IT") & (df.year!='2018')].groupby('year').id.count()

plt.plot(count_EA, label="EA")
plt.plot(count_DE, label="DE")
plt.plot(count_ES, label="ES")
plt.plot(count_FR, label="FR")
plt.plot(count_IT, label="IT")
plt.legend()


anno1_de = df[(df.country=="DE") & (df.year=="2016")].id
anno2_de = df[(df.country=="DE") & (df.year=="2017")].id

anno1_de = anno1_de[~anno1_de.isin(anno2_de)]


lev_EA = df[df.year!='2018'].groupby('year').apply(wavg,"short_term_lev", "tot_assets")
lev_DE = df[(df.country=="DE") & (df.year!='2018')].groupby('year').apply(wavg,"short_term_lev", "tot_assets")
lev_ES = df[(df.country=="ES") & (df.year!='2018')].groupby('year').apply(wavg,"short_term_lev", "tot_assets")
lev_FR = df[(df.country=="FR") & (df.year!='2018')].groupby('year').apply(wavg,"short_term_lev", "tot_assets")
lev_IT = df[(df.country=="IT") & (df.year!='2018')].groupby('year').apply(wavg,"short_term_lev", "tot_assets")
...
lev_EA = df[df.year!='2018'].groupby('year').apply(wavg,"long_term_lev", "tot_assets")
lev_DE = df[(df.country=="DE") & (df.year!='2018')].groupby('year').apply(wavg,"long_term_lev", "tot_assets")
lev_ES = df[(df.country=="ES") & (df.year!='2018')].groupby('year').apply(wavg,"long_term_lev", "tot_assets")
lev_FR = df[(df.country=="FR") & (df.year!='2018')].groupby('year').apply(wavg,"long_term_lev", "tot_assets")
lev_IT = df[(df.country=="IT") & (df.year!='2018')].groupby('year').apply(wavg,"long_term_lev", "tot_assets")
